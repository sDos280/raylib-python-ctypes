...
class ConfigFlags:
    ...
    FLAG_WINDOW_UNDECORATED = int(0x00000008)  # Set to disable window decoration (frame and buttons)
    FLAG_WINDOW_HIDDEN = int(0x00000080)  # Set to hide window
    FLAG_WINDOW_MINIMIZED = int(0x00000200)  # Set to minimize window (iconify)
    FLAG_WINDOW_MAXIMIZED = int(0x00000400)  # Set to maximize window (expanded to monitor)
    FLAG_WINDOW_UNFOCUSED = int(0x00000800)  # Set to window non focused
    FLAG_WINDOW_TOPMOST = int(0x00001000)  # Set to window always on top
    FLAG_WINDOW_ALWAYS_RUN = int(0x00000100)  # Set to allow windows running while minimized
    FLAG_WINDOW_TRANSPARENT = int(0x00000010)  # Set to allow transparent framebuffer
    FLAG_WINDOW_HIGHDPI = int(0x00002000)  # Set to support HighDPI
    FLAG_WINDOW_MOUSE_PASSTHROUGH = int(
        0x00004000)  # Set to support mouse passthrough, only supported when FLAG_WINDOW_UNDECORATED
    FLAG_MSAA_4X_HINT = int(0x00000020)  # Set to try enabling MSAA 4X

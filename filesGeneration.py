...
# generate_structs_py_pyi_code(raymath_api_structs, raymath_api_aliases) raymath_api_aliases just redeclare some stuff, so we don't need it
generate_structs_py_pyi_code(raymath_api_structs, dict())

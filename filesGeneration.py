...
config_defines_code = indent_string(generate_defines_code(config_api_defines), 1) + "\n"
rlgl_defines_code = indent_string(generate_defines_code(rlgl_api_defines), 1) + "\n"
raylib_defines_code = indent_string(generate_defines_code(raylib_api_defines), 1) + "\n"
raymath_defines_code = indent_string(generate_defines_code(raymath_api_defines), 1) + "\n"
raygui_defines_code = indent_string(generate_defines_code(raygui_api_defines), 1) + "\n"

config_enums_code = indent_string(generate_enums_code(config_api_enums), 1) + "\n"
rlgl_enums_code = indent_string(generate_enums_code(rlgl_api_enums), 1) + "\n"
raylib_enums_code = indent_string(generate_enums_code(raylib_api_enums), 1) + "\n"
raymath_enums_code = indent_string(generate_enums_code(raymath_api_enums), 1) + "\n"
raygui_enums_code = indent_string(generate_enums_code(raygui_api_enums), 1) + "\n"
